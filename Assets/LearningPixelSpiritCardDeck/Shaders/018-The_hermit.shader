Shader "Unlit/018-The_hermit"
{
    Properties
    {
        ...
        [Space(12)]
        _RhombSize("_RhombSize", Float) = 1
        [Vector2] _RhombOffset("RhombOffset", Vector) = (0,0,0,0)
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float rhombSDF = RhombSDF(scaleUV + _RhombOffset);

                float finalFactor = Fill(triangleSDF, _TriangleSize);
                finalFactor = XOr(finalFactor, Fill(rhombSDF, _RhombSize));
